...
const testimonials = [
  {
    quote:
      "AriloTec transformed our fraud detection system from a rule-based nightmare into an intelligent ML pipeline. We saw a 67% reduction in false positives within 3 months of go-live. Their team understood our compliance constraints from day one.",
    author: "Priya Mehta",
  ...
  {
    quote:
      "We engaged AriloTec for a generative AI project and they delivered something that genuinely impressed our board. The RAG-based knowledge management system they built reduced our customer support resolution time by 45%. Exceptional quality.",
  ...
  {
    quote:
      "AriloTec built our AI-powered patient risk stratification model that is now being used across 12 hospitals in our network. The team's domain knowledge of healthcare combined with their ML expertise is rare and incredibly valuable.",
  ...
  {
    quote:
      "We needed an AI agent that could automate our procurement workflows end-to-end. AriloTec delivered a multi-agent system using LangGraph that handles 80% of our purchase orders autonomously. ROI was achieved in 4 months.",
        ...
        <SectionHeader
          ...
          title={
            <>
              ...
              <span className="gradient-text">About AriloTec</span>
            </>
          }
          className="mb-16"
        />
